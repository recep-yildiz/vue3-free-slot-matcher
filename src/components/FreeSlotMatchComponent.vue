  ...
  <div class="mainContainer">
    ...
    <div class="inputs">
      <div id="slotInputDiv">
        ...
        <input type="number" id="slots" min="1" max="5" v-model.number="numSlots" @input="generateGrid" />
      </div>
...
export default {
  ...
  setup() {
    ...
    const gridStyle = computed(() => {
      ...
      return {
        gridTemplateColumns: `repeat(${state.numMembers}, ` +  window.innerWidth > 768 ? ` 50px)` : ` 30px)`
      };
    });

     const reactiveRowStyle = computed(() => {
      return {
        gridTemplateColumns: `repeat(${state.numMembers}, 1fr`
      };
    });
